 ...
 * 
 */
function k_ajax_upload_veteran_paperwork() {
  $image = $_POST['paperwork'];
  ...
  var_dump($attach_id);
//   $image_data = base64_decode($_POST['paperwork_b64_string']);
//   $image = imagejpeg($image_data);
//   $filename = $_POST['filename'];
// var_dump($image);
//   $upload_dir = wp_upload_dir();
...
//   var_dump(wp_get_attachment_url($attach_id));

  // update_field('veteran_application_paperwork', $paperwork, 'user_' . get_current_user_id());

  die();
}
add_action('wp_ajax_upload_veteran_paperwork', 'k_ajax_upload_veteran_paperwork');
add_action('wp_ajax_nopriv_upload_veteran_paperwork', 'k_ajax_upload_veteran_paperwork');
