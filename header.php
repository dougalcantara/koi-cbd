...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-89400757-2"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    gtag('config', 'UA-89400757-2');
  </script>
  <!-- Facebook Pixel Code -->
  <script>
		...
		fbq('init', '478439756066470');
		fbq('track', 'PageView');
		</script>
		<noscript>
		<img height="1" width="1"
		src="https://www.facebook.com/tr?id=478439756066470&ev=PageView
		&noscript=1"/>
	</noscript>
    ...
    snaptr('init', 'd0eb1851-7384-4680-bc95-6c44ce4708f7', { 
