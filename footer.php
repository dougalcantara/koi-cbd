...
?>
  ...
  <?php if ($wp->request == 'checkout') : ?>
    ...
    <script type="text/javascript" src="https://koicbd.com/wp-content/plugins/woocommerce-square/vendor/skyverge/wc-plugin-framework/woocommerce/payment-gateway/assets/js/frontend/sv-wc-payment-gateway-payment-form.min.js?ver=5.4.0"></script>
    <script type="text/javascript" src="https://koicbd.com/wp-content/plugins/woocommerce-square/assets/js/frontend/wc-square.min.js?ver=2.0.8"></script>
  <?php endif; ?>
